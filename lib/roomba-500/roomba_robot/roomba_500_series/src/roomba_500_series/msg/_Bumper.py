...
"""autogenerated by genpy from roomba_500_series/Bumper.msg. Do not edit."""
import sys
...
class Bumper(genpy.Message):
  ...
  _type = "roomba_500_series/Bumper"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B3I().pack(_x.left.state, _x.right.header.seq, _x.right.header.stamp.secs, _x.right.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.right.state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.left.state, _x.right.header.seq, _x.right.header.stamp.secs, _x.right.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      (self.right.state,) = _get_struct_B().unpack(str[start:end])
