...
(cl:defmethod cl:initialize-instance :after ((m <PlaySong>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlaySong)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<PlaySong> is deprecated: use roomba_500_series-msg:PlaySong instead.")))
