...
(cl:defmethod cl:initialize-instance :after ((m <Brushes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Brushes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<Brushes> is deprecated: use roomba_500_series-msg:Brushes instead.")))
...
(cl:defmethod main_brush-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:main_brush-val is deprecated.  Use roomba_500_series-msg:main_brush instead.")
  (main_brush m))

(cl:ensure-generic-function 'main_brush_pwm-val :lambda-list '(m))
(cl:defmethod main_brush_pwm-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:main_brush_pwm-val is deprecated.  Use roomba_500_series-msg:main_brush_pwm instead.")
  (main_brush_pwm m))

(cl:ensure-generic-function 'main_brush_direction-val :lambda-list '(m))
(cl:defmethod main_brush_direction-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:main_brush_direction-val is deprecated.  Use roomba_500_series-msg:main_brush_direction instead.")
  (main_brush_direction m))

(cl:ensure-generic-function 'side_brush-val :lambda-list '(m))
(cl:defmethod side_brush-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:side_brush-val is deprecated.  Use roomba_500_series-msg:side_brush instead.")
  (side_brush m))

(cl:ensure-generic-function 'side_brush_pwm-val :lambda-list '(m))
(cl:defmethod side_brush_pwm-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:side_brush_pwm-val is deprecated.  Use roomba_500_series-msg:side_brush_pwm instead.")
  (side_brush_pwm m))

(cl:ensure-generic-function 'side_brush_clockwise-val :lambda-list '(m))
(cl:defmethod side_brush_clockwise-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:side_brush_clockwise-val is deprecated.  Use roomba_500_series-msg:side_brush_clockwise instead.")
  (side_brush_clockwise m))

(cl:ensure-generic-function 'vacuum-val :lambda-list '(m))
(cl:defmethod vacuum-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:vacuum-val is deprecated.  Use roomba_500_series-msg:vacuum instead.")
  (vacuum m))

(cl:ensure-generic-function 'vacuum_pwm-val :lambda-list '(m))
(cl:defmethod vacuum_pwm-val ((m <Brushes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:vacuum_pwm-val is deprecated.  Use roomba_500_series-msg:vacuum_pwm instead.")
  (vacuum_pwm m))
