...
(cl:defmethod cl:initialize-instance :after ((m <DigitLeds>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitLeds)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<DigitLeds> is deprecated: use roomba_500_series-msg:DigitLeds instead.")))
...
(cl:defmethod digits-val ((m <DigitLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:digits-val is deprecated.  Use roomba_500_series-msg:digits instead.")
  (digits m))
