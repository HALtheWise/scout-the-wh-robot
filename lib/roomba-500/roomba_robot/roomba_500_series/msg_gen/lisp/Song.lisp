...
(cl:defclass <Song> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (notes
    :reader notes
    :initarg :notes
    :type (cl:vector roomba_500_series-msg:Note)
   :initform (cl:make-array 0 :element-type 'roomba_500_series-msg:Note :initial-element (cl:make-instance 'roomba_500_series-msg:Note))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Song>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Song)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<Song> is deprecated: use roomba_500_series-msg:Song instead.")))
...
(cl:defmethod song_number-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:song_number-val is deprecated.  Use roomba_500_series-msg:song_number instead.")
  (song_number m))

(cl:ensure-generic-function 'notes-val :lambda-list '(m))
(cl:defmethod notes-val ((m <Song>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:notes-val is deprecated.  Use roomba_500_series-msg:notes instead.")
  (notes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Song>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'notes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'roomba_500_series-msg:Note))
