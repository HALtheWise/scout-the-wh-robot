...
(cl:defmethod cl:initialize-instance :after ((m <ScheduleLeds>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScheduleLeds)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<ScheduleLeds> is deprecated: use roomba_500_series-msg:ScheduleLeds instead.")))
...
(cl:defmethod sunday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:sunday-val is deprecated.  Use roomba_500_series-msg:sunday instead.")
  (sunday m))

(cl:ensure-generic-function 'monday-val :lambda-list '(m))
(cl:defmethod monday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:monday-val is deprecated.  Use roomba_500_series-msg:monday instead.")
  (monday m))

(cl:ensure-generic-function 'tuesday-val :lambda-list '(m))
(cl:defmethod tuesday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:tuesday-val is deprecated.  Use roomba_500_series-msg:tuesday instead.")
  (tuesday m))

(cl:ensure-generic-function 'wednesday-val :lambda-list '(m))
(cl:defmethod wednesday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:wednesday-val is deprecated.  Use roomba_500_series-msg:wednesday instead.")
  (wednesday m))

(cl:ensure-generic-function 'thursday-val :lambda-list '(m))
(cl:defmethod thursday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:thursday-val is deprecated.  Use roomba_500_series-msg:thursday instead.")
  (thursday m))

(cl:ensure-generic-function 'friday-val :lambda-list '(m))
(cl:defmethod friday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:friday-val is deprecated.  Use roomba_500_series-msg:friday instead.")
  (friday m))

(cl:ensure-generic-function 'saturday-val :lambda-list '(m))
(cl:defmethod saturday-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:saturday-val is deprecated.  Use roomba_500_series-msg:saturday instead.")
  (saturday m))

(cl:ensure-generic-function 'colon-val :lambda-list '(m))
(cl:defmethod colon-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:colon-val is deprecated.  Use roomba_500_series-msg:colon instead.")
  (colon m))

(cl:ensure-generic-function 'pm-val :lambda-list '(m))
(cl:defmethod pm-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:pm-val is deprecated.  Use roomba_500_series-msg:pm instead.")
  (pm m))

(cl:ensure-generic-function 'am-val :lambda-list '(m))
(cl:defmethod am-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:am-val is deprecated.  Use roomba_500_series-msg:am instead.")
  (am m))

(cl:ensure-generic-function 'clock-val :lambda-list '(m))
(cl:defmethod clock-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:clock-val is deprecated.  Use roomba_500_series-msg:clock instead.")
  (clock m))

(cl:ensure-generic-function 'schedule-val :lambda-list '(m))
(cl:defmethod schedule-val ((m <ScheduleLeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:schedule-val is deprecated.  Use roomba_500_series-msg:schedule instead.")
  (schedule m))
