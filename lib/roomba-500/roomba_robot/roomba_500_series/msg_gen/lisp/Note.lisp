...
(cl:defmethod cl:initialize-instance :after ((m <Note>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Note)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roomba_500_series-msg:<Note> is deprecated: use roomba_500_series-msg:Note instead.")))

(cl:ensure-generic-function 'note-val :lambda-list '(m))
(cl:defmethod note-val ((m <Note>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:note-val is deprecated.  Use roomba_500_series-msg:note instead.")
  (note m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <Note>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roomba_500_series-msg:length-val is deprecated.  Use roomba_500_series-msg:length instead.")
  (length m))
